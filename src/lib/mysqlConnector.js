...
class MySQLConnector {
    ...
    get MYSQL_DB_NAME() { return process.env.MYSQL_DB_NAME || 'Rocket_Elevators_Information_System_development' }
    get MYSQL_DB_PASSWORD() { return process.env.MYSQL_DB_PASSWORD || '123' }
